...
const DynamicChat = ({ isOpen, setIsOpen, handleSideBarToggle }) => {
  ...
  return (
    <div
      className={`ml-3 flex flex-col max-h-screen  ${
        isOpen && "hidden md:flex"
      }`}
    >
      {console.log(org_id)}
      <div className="flex justify-between items-center p-4 bg-[#F1F3F4] border-b-2 border-gray-300">
        <div></div>
